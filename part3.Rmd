...
We perform some quality control to remove low-quality cells using the `calculateQCMetrics` function [@mccarthy2016scater].
...
out2 <- plotReducedDim(sce.block, use_dimred="PCA", ncomponents=2, 
