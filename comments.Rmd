...
The log-transformation is convenient as it means that differences between log-expression values directly represent log-fold changes.
...
The log-transformation also provides some measure of variance stabilization for NB-distributed counts with a constant dispersion but a variable mean. 
...
There's no reason to think that the comparison of mean counts is more meaningful than the comparison of mean log-counts.
