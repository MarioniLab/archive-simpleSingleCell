...
In genomics data with thousands of dimensions, any value above 0.2 is probably fine.
I would consider 0.5 as a strong clustering value, i.e., points in the next cluster are twice as far away as points in the current cluster.
