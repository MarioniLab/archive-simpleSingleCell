...
Even if they have large log-fold changes, genes with only small _absolute_ changes in expression are less likely to contribute to phenotypic differences.
