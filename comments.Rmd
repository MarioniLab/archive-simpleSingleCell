...
## More comments on the "at least _n_" filter

Another consideration is that the expected number of zeros is a function of both the mean and the dispersion.
If you're just interested in abundance, then you want to filter directly on the mean, without getting interference from the dispersion.
That said, I don't think it really matters, the only purpose is to prune out some genes before HVG detection.
