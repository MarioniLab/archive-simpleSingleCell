...
This seems to be caused by cell- and spike-specific amplification biases that introduce additional variability for a few spike-ins.
...
This affects all HVG detection methods, though to differing extents.
