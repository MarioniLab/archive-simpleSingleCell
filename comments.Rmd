...
Whether total RNA content is "interesting" or not depends on whether it is relevant to function.
A global increase in transcriptional activity may not be biologically important if it just randomly fluctuates due to cell size, number of ribosomes, etc.
In this case, retaining the effects of total RNA content would just increase the amount of biological noise in the data.
On the other hand, it may be important if the phenotype of interest is associated with transcriptional activity.
Functionally relevant genes may be co-regulated along with the majority of genes when total RNA content changes.
...
While this seems obviously inappropriate, consider the following:
