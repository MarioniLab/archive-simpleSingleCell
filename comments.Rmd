...
### Dealing with subtle subpopulations

A similar issue arises for clustering of large but subtle subpopulations (i.e., subpopulations consisting of many cells, which are poorly separated from neighbouring subpopulations). 
...
### Dealing with rare subpopulations
