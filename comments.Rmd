...
## Using log-count variances over the CV^2^

As mentioned, log-count variances are more robust to outliers
This is also more consistent with downstream applications.
