...
This discards some resolution of biological structure, which is tolerable as the point of pre-clustering is to reduce DE genes rather than to identify subpopulations.
...
# Though this effect seems to be driven by differences in spread, rather than a shift in location.
...
# And indeed, this can be overridden by genuine structure.
a[1:10,1:50] <- 2
b[1:10,1:50] <- 200
y <- cbind(a, b)
