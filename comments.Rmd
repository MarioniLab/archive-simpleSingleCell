...
If the assumption above is violated, the only solution is to set some hard absolute threshold (to distinguish between relatively poor and absolutely poor).
This requires a _lot_ of context and/or experience to get right - at least, some fiddling with the threshold would be needed.
Identifying outliers directly from the endogenous genes is not ideal, as this would just eliminate rare subpopulations and understate cellular heterogeneity.
