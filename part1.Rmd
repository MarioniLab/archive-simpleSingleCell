...
- Users can set `use.spikes=FALSE` to fit a trend to the variances of the endogenous genes in the absence of spike-in transcripts.
However, this requires some care in interpretation of the results, which will be discussed later.
...
This can be used in validation studies to identify the corresponding cells in an independent replicate population,
based on whether they express the upregulated markers and do not express the downregulated markers.
