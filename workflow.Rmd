...
- Setting `approximate=TRUE` wil perform an approximate singular value decomposition, using methods from the `r CRANpkg("irlba")` package.
...
plotDiffusionMap(sce.block, use_reddim="PCA", colour_by="Gata3") + fontsize
```
...
sce <- SingleCellExperiment(list(counts=incoming), rowData=anno)
isSpike(sce, "ERCC") <- is.spike
