...
```{r, fig.cap="Size factors from spike-in normalization, shown against the size factors from deconvolution for all cells in the HSC data set. Axes are shown on a log-scale."}
