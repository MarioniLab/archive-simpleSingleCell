...
plot(pr.out$x[,1], pr.out$x[,2], col=colors[hard.assign], pch=16, 
    xlab="PC1", ylab="PC2", main="Before removal")
...
plot(pr.out2[,1], pr.out2[,2], col=colors[hard.assign], pch=16,
    xlab="PC1", ylab="PC2", main="After removal")
```
