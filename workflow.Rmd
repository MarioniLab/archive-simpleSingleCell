...
<!-- 
MAD-based definitions don't seem to work as the MAD is too large, so median-MAD*3 ends up being negative. 
Maybe logging it would be better before computing MADs, but then it wouldn't be as interpretable.
-->
