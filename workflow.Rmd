...
If a non-negligible number of cells are in other phases, we can also use the assigned phase as a blocking factor in downstream analyses.
This protects against cell cycle effects without involving substantial loss of information.
