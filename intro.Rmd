...
**Part 1** will introduce most of the concepts for scRNA-seq data analysis, using a small read count dataset of 192 cells from an immortalized myeloid progenitor cell line.

**Part 2** will apply the concepts to a larger UMI dataset containing over 3000 brain cells, with specific modifications to accommodate lower counts and more cells.

**Part 3** will describe some miscellaneous alternative procedures that were not previously covered, using a variety of relevant datasets.
