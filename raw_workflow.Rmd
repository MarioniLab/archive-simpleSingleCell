...
One could argue that this is not problematic if you just get more low-variability genes, but technical noise is still high (in absolute terms) and there are a lot more of them.
