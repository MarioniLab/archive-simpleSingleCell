...
cat("***Note:*** *for how to cite this article, please refer to http://f1000research.com/articles/5-2122/v1 for instructions.*")
```
...
```{r, eval=!on.bioc, echo=FALSE, results='asis'}
