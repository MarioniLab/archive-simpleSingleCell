...
This allows us to identify confounding technical effects that need to be incorporated into downstream models.
...
This metric does not associate with any obvious substructure in Figure ((tsneplothsc)), and while it correlates well with the first principal component in Figure ((pcaplothsc)), this only explains a small percentage of the total variance.
