...
We extract all genes associated with the relevant GO terms and use them to construct a PCA plot.
...
```{r braincyclepca, fig.width=10, fig.height=5, fig.cap="PCA plots of the brain data set, using only genes with annotated functions in cell cycling or division."}
pca1 <- plotPCA(sce, feature_set=chosen.genes) + fontsize 
multiplot(pca1, pca2, cols=2)
```
...
We can include these factors as covariates in our design matrix to absorb cell cycle effects in the rest of the data set.
