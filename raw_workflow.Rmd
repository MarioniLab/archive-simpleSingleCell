...
This threshold is chosen as genes with lower averages are more likely to be dominated by zero counts (based roughly on a negative binomial distribution for the counts).
...
(The technical noise is also lower, which reduces the risk of being dominated by zeroes and allows retention of genes with lower means.)
