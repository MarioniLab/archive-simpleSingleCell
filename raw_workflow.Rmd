...
Application of `cyclone` to the brain dataset suggests that most of the cells are in G1 phase (Figure ((phaseplotbrain))).
...
Figure ((hvgplotbrain)) suggests that the trend is fitted accurately to the technical variances for each sex.
