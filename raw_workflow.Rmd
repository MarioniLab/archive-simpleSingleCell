...
Application of `cyclone` to these cells may not be appropriate, because `cyclone` assumes that each cell must belong to one of the G1, S or G2/M phases.
To avoid problems due to incorrect classification, we will not perform any processing of this dataset by cell cycle phase.
