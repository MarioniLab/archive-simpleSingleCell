...
<!--
The mean-based filter also means that, if a gene is only expressed in 'p' proportion of cells, then the expression in each cell must be '1/p' to be retained.
This makes sense; the fewer cells a gene is expressed in, the more highly that gene must be expressed in order for us to believe that it's not just noise.
-->
