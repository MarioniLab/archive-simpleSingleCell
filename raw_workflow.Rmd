...
However, a small number of cells lie in the centre of the plot with ambiguous scores.
...
These new biases (and the absence of expected biases) may interfere with accurate calling of cell cycle phase.
...
An additional complication is that many neuronal cell types are postmitotic and do not belong in any phase of the cell cycle.
It is not clear how these cells should be classified -- so, to avoid misleading conclusions, we will not perform any processing of this dataset by cell cycle phase.
