...
dummy <- newSCESet(t(reducedDimension(sce)))
dummy$total_features <- sce$total_features
out5 <- plotTSNE(dummy, pca=FALSE, perplexity=5, colour_by="total_features", 
    rand_seed=100) + fontsize + ggtitle("Perplexity = 5")
out10 <- plotTSNE(dummy, pca=FALSE, perplexity=10, colour_by="total_features",
    rand_seed=100) + fontsize + ggtitle("Perplexity = 10")
out20 <- plotTSNE(dummy, pca=FALSE, perplexity=20, colour_by="total_features",
...
We can study this in more detail by detecting genes that are differentially expressed along the first PC, using methods from the _limma_ package.
...
For example, a number of these genes are involved in DNA replication and the cell cycle.
