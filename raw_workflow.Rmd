...
Figure ((hvgboxplotmesc)) suggests that each of the top genes is exhibiting robust DE across a number of cells.
...
An increase in the upper tail of the distribution is also relevant and will be detected, provided there are sufficient cells in that tail.

```{r hvgboxplotmesc, fit.width=10, fig.height=6, fig.cap="Boxplots of batch-corrected normalized log-expression values for the top 10 DEGs in the mESC data set, detected after        summing counts for all cells on each plate."}
