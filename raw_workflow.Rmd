...
Finally, we denoise the expression values using our PCA-based approach, using only the genes with positive biological components.
This yields a low-rank approximation where the technical noise has been removed.

```{r}
sce <- denoisePCA(sce, value="lowrank", subset.row=var.out$bio > 0)
```
