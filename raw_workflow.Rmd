...
- Trend fitting is complicated by the small number of spike-in transcripts, the uneven distribution of their abundances and (for low numbers of cells) the low precision of the variance estimates.
Some tuning of trend parameters such as `span` may be required - see `?trendVar` for more details.
...
### Alternative methods for HVG detection
