...
(The _p_-value shown below tests for whether the biological component is significantly greater than 1.
A variance of 1 for log~2~-counts means that significant genes will vary, for biological reasons, by at least 2-fold around the mean.
However, ranking on the _p_-value tends to be less effective as it favours genes that have more precise variance estimates, even if they are smaller than estimates for other genes.)
