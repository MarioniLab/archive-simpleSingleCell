...
If these rare cells are of interest, alternative methods for HVG identification may be preferable, e.g., using the `DM` or `technicalCV2` methods in `r Biocpkg("scran")`.
