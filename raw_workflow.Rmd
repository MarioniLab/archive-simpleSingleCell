...
The distributions of these metrics are shown in Figure ((qcplothsc)).
...
We define the abundance of each gene as the average count across all cells, with some adjustment for library size differences between cells (Figure ((abhisthsc))).
...
This is closely related to the average count for most genes, as expression in many cells will result in a higher average (Figure ((nexprshisthsc))).
